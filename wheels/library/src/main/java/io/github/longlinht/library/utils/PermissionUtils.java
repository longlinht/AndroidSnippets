...
import io.github.longlinht.library.utils.constants.PermissionConstants;
import io.github.longlinht.library.utils.constants.PermissionConstants.Permission;
...
public final class PermissionUtils {
     ...
     * 悬浮窗      特殊权限
     */
    public static String[] startPerms = {
            Manifest.permission.WRITE_EXTERNAL_STORAGE, // 存储空间
            Manifest.permission.READ_PHONE_STATE  // 电话
    };

    public static String[] videoPerms = {
            Manifest.permission.CAMERA,     // 相机
            Manifest.permission.RECORD_AUDIO,    // 录音
    };

    public static String[] audioPerms = {
            Manifest.permission.RECORD_AUDIO   // 录音

    };

    public static String[] photoPerms = {Manifest.permission.CAMERA};  // 相机

    public static String[] audioRecordPerms = {Manifest.permission.RECORD_AUDIO};  // 录音

    public static String[] fineLocationPerms = {Manifest.permission.ACCESS_FINE_LOCATION};// 位置

    public static String[] liveRecordPerms = {
            Manifest.permission.WRITE_EXTERNAL_STORAGE, // 存储空间
            Manifest.permission.RECORD_AUDIO,  // 录音
    };
     ...
     */
    public static boolean hasPermissions(@NonNull String... perms) {
        ...
        for (String perm : perms) {
            boolean hasPerm = (ContextCompat.checkSelfPermission(GlobalContext.getAppContext(), perm) ==
                    PackageManager.PERMISSION_GRANTED);
            if (!hasPerm) {
                return false;
            }
    ...
    public static boolean hasStartPermission() {
        return hasPermissions(startPerms);
    }
