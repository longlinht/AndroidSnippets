...
import io.github.longlinht.library.imagepicker.bean.ImageFolder;
import io.github.longlinht.library.imagepicker.bean.ImageItem;
import io.github.longlinht.library.imagepicker.loader.ImageLoader;
import io.github.longlinht.library.imagepicker.util.ProviderUtil;
import io.github.longlinht.library.imagepicker.util.Utils;
...
public class ImagePicker {
    ...
    private Style style = Style.RECTANGLE; //裁剪框的形状
    ...
    public void restoreInstanceState(Bundle savedInstanceState) {
        ...
        style = (Style) savedInstanceState.getSerializable("style");
