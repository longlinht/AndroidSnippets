...
public class AndroidBuild {
    ...
    public static class VERSION_CODES {
         ...
         * {android.preference.PreferenceActivity#isValidFragment
         * PreferenceActivity.isValueFragment} becomes false instead of true.</li>
         * <li>In {@link android.webkit.WebView}, apps targeting earlier
         * versions will have JS URLs evaluated directly and any result of the
         * evaluation will not replace the current page content. Apps targetting
         * KITKAT or later that load a JS URL will have the result of that URL
         * replace the content of the current page</li>
         * <li> {@link android.app.AlarmManager#set AlarmManager.set} becomes
         * interpreted as an inexact value, to give the system more flexibility
         * in scheduling alarms.</li>
         * <li>
         * {@link android.content.Context#getSharedPreferences(String, int)
         * Context.getSharedPreferences} no longer allows a null name.</li>
         * <li> {@link android.widget.RelativeLayout} changes to compute wrapped
         * content margins correctly.</li>
         * <li> {@link android.app.ActionBar}'s window content overlay is allowed
         * to be drawn.</li>
         * </ul>
         */
